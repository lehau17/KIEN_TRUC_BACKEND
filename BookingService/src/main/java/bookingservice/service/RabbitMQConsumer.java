...
public class RabbitMQConsumer {
    ...
    public void receiveBookingMessage(BookingMessage message) throws InterruptedException {
    ...
    public void receiveConfirmMessage(BookingMessage message) throws InterruptedException {
    ...
    public void receiveCancelMessage(BookingMessage message) throws InterruptedException {
    ...
    public void receiveCheckInMessage(BookingMessage message) throws InterruptedException {
    ...
    public void receiveCheckOutMessage(BookingMessage message) throws InterruptedException {
